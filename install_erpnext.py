...
def setup_folders(install_path):
	...
	if not os.path.exists(app):
		...
		exec_in_shell("cd %s && git clone https://github.com/XWARIOSWX/erpnext.git app" % install_path)
	...
	if not os.path.exists(lib):
		...
		exec_in_shell("cd %s && git clone https://github.com/XWARIOSWX/wnframework.git lib" % install_path)
